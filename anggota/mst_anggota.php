    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
                <p><a class="btn btn-primary" href="index.php?pilih=1.2&aksi=aktif"><i
                            class="glyphicon glyphicon-sd-video"></i> Aktif</a> <a class="btn btn-primary"
                        href="index.php?pilih=1.2&aksi=keluar"><i class="glyphicon glyphicon-subtitles"></i>
                        Nonaktif</a> <a href="?pilih=1.2&aksi=tambah" class="btn btn-primary"><span
                            class='glyphicon glyphicon-plus'></span> Tambah Anggota</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel" style="width:50%;">
                ...
                <form action="anggota/proses_anggota.php?pros=tambah" method="post" id="form" role="form"
                    enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Kode Anggota</label>
                        <input type="text" name="kode_anggota" class="form-control" size="54px"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="simpanan_pokok" class="form-control" size="54" id="simpanan_pokok"
                            class="required" readonly="" value="<?php echo $data['besar_simpanan'];?>">
                    </div>
                    <div class="form-group">
                        <label>Nama Lengkap</label>
                        <input type="text" name="nama_anggota" class="form-control" size="54" class="required"
                            title="Nama harus diisi" />
                    </div>
                    <div class="form-group">
                        <label>Jenis Kelamin</label>
                        <input type="radio" name="jenis_kelamin" value="Laki-laki" class="required"
                            title="Jenis Kelamin harus diisi" /> Laki-laki
                        <input type="radio" name="jenis_kelamin" value="Perempuan" class="required"
                            title="Jenis Kelamin harus diisi" /> Perempuan
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tgl_lahir" class="required"
                            title="Tanggal Lahir harus diisi">
                    </div>
                    <div class="form-group">
                        <label>Alamat Anggota</label>
                        <input type="text" name="alamat_anggota" class="form-control" id="alamat_anggota" rows="5"
                            cols="41" class="required" title="Alamat harus diisi" />
                    </div>
                    <div class="form-group">
                        <label>Telepon</label>
    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel" style="width:50%;">
                ...
                <form action="anggota/edit_anggota.php" method="get" id="form" role="form"
                    enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Kode Anggota</label>
                        <input type="text" name="kode_anggota" class="form-control" size="54px"
                            value="<?php echo $data2['kode_anggota'];?>" readonly />
                    </div>
                    <div class="form-group">
                        <label>Tanggal Masuk</label>
                        <input type="date" value="<?php echo $data2['tgl_masuk'];?>" class="form-control"
                            name="tgl_masuk">
                    </div>
                    <div class="form-group">
                        <label>Nama Lengkap</label>
                    ...
                    <div class="form-group">
                        <label>Tempat Lahir</label>
                        <input type="text" class="form-control" value="<?php echo $data2['tempat_lahir'];?>"
                            name="tmp_lahir" />
                    </div>
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input type="date" name="tgl_lahir" class="form-control"
                            value="<?php echo $data2['tgl_lahir'];?>">
                    </div>
                    <div class="form-group">
                        <label>Alamat Anggota</label>
                        <input type="text" name="alamat_anggota" value="<?php echo $data2['alamat_anggota'];?>"
                            class="form-control" />
                    </div>
                    <div class="form-group">
                        <label>Telepon</label>
                    ...
                    <div class="form-group">
                        <label>Tanggal Entri</label>
                        <input type="date" name="tgl_entri" class="form-control" value="<?php echo date("Y-m-d");?>"
                            readonly>
                    </div>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-success btn-xs"
                                        href="index.php?pilih=1.2&aksi=ubah&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
                                            class="glyphicon glyphicon-pencil"></i> Edit</a>
                                    <script type="text/javascript">
                                        function hapus() {
                                            var msg = confirm(
                                                "Jika anda menghapus data ini ,seluruh transaksi data ini juga akan dihapus. Anda Yakin ?"
                                                );
                                            if (msg == true) {
                                                window.location =
                                                    "anggota/proses_anggota.php?pros=keluar&kode_anggota=<?php echo $data['kode_anggota'];?>";
                                            } else {
                                    ...
                                    <a class="btn btn-primary btn-xs"
                                        href="anggota/proses_anggota.php?pros=keluar&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
                                            class="glyphicon glyphicon-off"></i> Keluar</a>
                                    <a class="btn btn-danger btn-xs"
                                        href="anggota/proses_anggota.php?pros=hapus&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
            ...
            ?>
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a class="btn btn-danger btn-xs"
                                        href="anggota/proses_anggota.php?pros=hapus&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
                                            class="glyphicon glyphicon-off"></i> Hapus</a>
                                </td>
                            </tr>
                            <?php
            $no++;} //tutup while
