...
<?php
    ...
    $pilih=$_GET['pilih'];
      switch($pilih){
        ...
        case "1.4"  : $tampil = "anggota/form_anggota_validasi.php"; break; 
        case "2.1"  : $tampil = "transaksi/transaksi.php"; break; 
        case "2.2"  : $tampil = "transaksi/transaksi_anggota.php"; break; 
...
<body>
    <section id="container">
        <?php if($_SESSION['level']=='admin') {
                ...
                echo '<header class="header" style="background-color:#b85c5c;">';
            }
        ?>
            ...
            <ul style="float:right; margin-top:12px;">
                <li>
                    ...
                    <a class="logout" href="login/proses_logout.php">
                      ...
                      {
                        echo '<button class="btn btn-danger" style="border:3px solid #fff;"><span class="glyphicon glyphicon-off"></span> Logout</button>';
                      }
                 ?>
                    </a></li>
            </ul>
            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="index.php?pilih=4.7"><i class="glyphicon glyphicon-tint"></i>Master Petugas</a>
                            </li>
                            ...
                            <li><a href="index.php?pilih=4.4&aksi=admin"><i class="fa fa-star"></i>Master Pengajuan</a>
                            <li><a href="index.php?pilih=1.4"><i class="fa fa-user"></i>Validasi Anggota</a></li>
                            </li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="index.php?pilih=3.3&aksi=semua"><i class="fa fa-share"></i> Data Pinjaman</a>
                            </li>
                            <li><a href="index.php?pilih=4.8"><i class="glyphicon glyphicon-question-sign"></i>
                                    Perbulan</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="index.php?pilih=4.1"><i class="glyphicon glyphicon-edit"></i> Setting
                                    Simpanan</a></li>
                            <li><a href="index.php?pilih=4.2"><i class="glyphicon glyphicon-share"></i> Setting
                                    Pinjaman</a></li>
                            <li><a href="index.php?pilih=4.3"><i class="glyphicon glyphicon-user"></i> Setting User</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                        <a target="_blank"
                            href="../../../phpmyadmin/db_export.php?db=rinookta&server=1&goto=db_qbe.php&token=042086e2593b7fe8fdb99ac76bb02f97"
                            target="_blank">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a href="index.php?pilih=1.3"><i class="fa fa-bitcoin"></i><span
                                style="font-size:120%; color:#fff;"> Master Tabungan</span></a>
                    </li>
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php } else if($_SESSION['status']=='tidak aktif') { ?>
                    <li class="sub-menu">
                        <a href="index.php?pilih=home">
                            <i class="glyphicon glyphicon-home"></i>
                            <span style="font-size:120%; color:#fff;">Home</span>
                    ...
                    <li class="sub-menu">
                        <a href="#">
                            ...
                            <span style="font-size:120%; color:#fff;">Akun Belum Aktif</span>
                        </a>
                    </li>
                    <?php } ?>
                </ul>
