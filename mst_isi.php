...
$a_anggota=mysql_query("SELECT * from t_anggota where kode_anggota='$data_login'");

$b_anggota=mysql_num_rows($a_anggota);
$c_anggota=mysql_fetch_array(mysql_query("SELECT SUM(besar_pinjam) as total_pinjam_anggota from t_pinjam where kode_anggota='$data_login'"));
$d_anggota=mysql_fetch_array(mysql_query("SELECT SUM(besar_angsuran) as total_angsuran_anggota from t_angsur where kode_anggota='$data_login'"));
$e_anggota=mysql_fetch_array(mysql_query("SELECT SUM(besar_tabungan) as total_tabungan_anggota from t_tabungan where kode_anggota='$data_login'"));
$f_anggota=mysql_fetch_array(mysql_query("SELECT SUM(denda) as denda from t_angsur_anggota where kode_anggota='$data_login'"));
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" href="index.php?pilih=1.2">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              <div class="panel-heading" style="background-color:#5bc0de; color:#fff;">
                <h3>Anggota <i class="fa fa-users" style="float:right;"></i></h3>
              </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              <div class="panel-heading" style="background-color:#5bc0de; color:#fff;">
                <h3>Pinjaman <i class="fa fa-dollar" style="float:right;"></i></h3>
              </div>
              <div class="panel-body">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              <div class="panel-heading" style="background-color:#5bc0de; color:#fff;">
                <h3>Angsuran <i class="fa fa-share" style="float:right;"></i></h3>
              </div>
              <div class="panel-body">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              <div class="panel-heading" style="background-color:#5bc0de; color:#fff;">
                <h3>Tabungan<i class="fa fa-save" style="float:right;"></i></h3>
              </div>
              <div class="panel-body">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              <div class="panel-heading" style="background-color:#5bc0de; color:#fff;">
                <h3>Denda<i class="glyphicon glyphicon-time" style="float:right;"></i></h3>
              </div>
              <div class="panel-body">
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box">
                  <div class="panel" style="border: 2px solid#5cb85c; ">
                    ...
                    <div class="panel-body">
                      <span style="font-size:20px;">Rp.
                        <?php echo number_format($c_anggota['total_pinjam_anggota']); ?></span>
                    </div>
                  </div>
                </div>
                </a>
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box">
                  <div class="panel" style="border: 2px solid#5cb85c; ">
                    ...
                    <div class="panel-body">
                      <span style="font-size:20px;">Rp.
                        <?php echo number_format($d_anggota['total_angsuran_anggota']); ?></span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box">
                  <div class="panel" style="border: 2px solid#5cb85c; ">
                    ...
                    <div class="panel-body">
                      <span style="font-size:20px;">Rp.
                        <?php echo number_format($e_anggota['total_tabungan_anggota']); ?></span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box">
                  <div class="panel" style="border: 2px solid#5cb85c; ">
                    ...
                    <div class="panel-body">
                      <span style="font-size:20px;">Rp. <?php echo number_format($f_anggota['denda_anggota']); ?></span>
                    </div>
                  </div>
                </div>
              </div>
