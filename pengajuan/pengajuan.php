  ...
  <div class="col-lg-12">
    <div class="form-panel">
      <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Data Pengajuan
        <span style="float:right;"> <input type="text" id="cari" style="width:230px;height:30px;font-size:15px;"
...
?>
      ...
      {?>
              <td align="center">
                <a class="btn btn-success btn-xs"
                  href="pengajuan/proses_pengajuan.php?proses=terima&kode_anggota=<?php echo $isi;?>&kode_pengajuan=<?php echo $data['kode_pengajuan'];?>"><i
                    class="glyphicon glyphicon-ok-circle"></i> Terima</a>
                <a class="btn btn-danger btn-xs"
                  href="pengajuan/proses_pengajuan.php?proses=tolak&kode_anggota=<?php echo $isi;?>&kode_pengajuan=<?php echo $data['kode_pengajuan'];?>"><i
                    class="glyphicon glyphicon-remove-circle"></i> Tolak</a>
              </td>
              <?php } ?>
      ...
      {?>
              <td align="center">
                <a class="btn btn-danger btn-xs"
                  href="pengajuan/proses_pengajuan.php?proses=hapus&kode_anggota=<?php echo $isi;?>&kode_pengajuan=<?php echo $data['kode_pengajuan'];?>"><i
...
<div class="row mt">
  <div class="col-lg-12">
    <div class="form-panel">
      <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Data Pengajuan
        <?php $dfl=mysql_fetch_array(mysql_query("SELECT *from t_anggota where kode_anggota='$kodeaa'")); echo $dfl['nama_anggota']; ?><span
          style="float:right;">
...
?>
      ...
      {?>
                  <td align="center">
                    <a class="btn btn-primary btn-xs" disabled="disabled"
                      href=index.php?pilih=4.3&aksi=ubah&kode_user=<?php echo $data['kode_pengajuan'];?>><i
      ...
      {?>
                  <td align="center">
                    <a class="btn btn-primary btn-xs" target="_blank"
                      href="pengajuan/print_pengajuan.php?kode_pengajuan=<?php echo $data['kode_pengajuan'];?>&sesion=<?php echo $_SESSION['kopname'];?>"><i
                        class="glyphicon glyphicon-print"></i> Print</a>
                  </td>
                  <?php } ?>
                  <?php if($data['status']=='ditolak')
...
<div class="row mt">
 ...
 ?>
        ...
        <div class="form-group">
          ...
          <select name="kode_jenis_pinjam" class="form-control">
            ...
            <?php
                ...
                ?>
            <option value="<?php echo $a['kode_jenis_pinjam'];?>"><?php echo $a['nama_pinjaman'];?> /Maks :
              <?php echo $a['maks_pinjam'];?> /Bunga : <?php echo $a['bunga'];?>% /Lama :
              <?php echo $a['lama_angsuran'];?> Bulan</option>
            <?php
                }
                ?>
          </select>
        ...
        <button id='hapus' class='btn btn-primary' onClick="self.history.back()"><span
            class='glyphicon glyphicon-trash'></span> Kembali</button>
      </form>
    </div>
  </div>
</div>
