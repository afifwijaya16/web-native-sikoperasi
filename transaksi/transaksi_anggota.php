...
<script language="JavaScript">
    ...
    $(document).ready(function () {
        $("#kategori").change(function () {
            ...
            if (kat == "tgl_simpan") {
                $("#cari").html(
                    '<input type=\"text\" name=\"input_cari\" id=\"tgl\" onclick=\"datePicker("tgl")\"/>'
                );
            } else {
            ...
            <div class="form-panel">
                ...
                <form class="form-inline" role="form">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <?php
			$query=mysql_query("SELECT * FROM t_anggota where kode_anggota='$data_login'");
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <!-- <a class="btn btn-primary btn-xs"
                                    href="index.php?pilih=2.1&aksi=simpanananggota&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
                                        class="glyphicon glyphicon-check"></i> Simpan</a>
                                <a class="btn btn-success btn-xs"
                                    href="index.php?pilih=2.1&aksi=pinjamangsur&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
                                        class="glyphicon glyphicon-edit"></i> Pinjam | <i
                                        class="glyphicon glyphicon-share"></i> Angsur</a> -->
                                <a class="btn btn-danger btn-xs"
                                    href="index.php?pilih=4.4&aksi=operator&kode_anggota=<?php echo $data['kode_anggota'];?>"><i
                                        class="glyphicon glyphicon-question-sign"></i> Pengajuan</a>
                            </td>
                        </tr>
                        <?php
	$no++;} //tutup while
        ...
        <div class="col-lg-12">
            <div class="form-panel" style="width:50%;">
                ...
                <form action="transaksi/proses_transaksi.php?pros=simpan" method="post" id="form" name="mainform"
                    onSubmit="validasiSimpan()">
                    <div class="form-group">
                        <label>Kode Anggota</label>
                        <input type="text" name="kode_anggota" size="34" title="Kode Anggota harus diisi" readonly=""
                            class="form-control" value="<?php echo $data2['kode_anggota'];?>">
                    </div>
                    <div class="form-group">
                        <label>Nama Anggota</label>
                        <input type="text" name="nama_anggota" size="54" class="form-control" readonly
                            value="<?php echo $data2['nama_anggota'];?>" />
                    </div>
                    <div class="form-group">
                        <label>pekerjaan</label>
                        <input type="text" name="pekerjaan" class="form-control" size="54" readonly
                            value="<?php echo $data2['pekerjaan'];?>" />
                    </div>
                    <div class="form-group">
                        <label>Jenis Simpanan</label>
                        <select name="kode_jenis_simpan" class="form-control" id="kode_jenis_simpan"
                            onChange="show(this.value)" class="required" title="Jenis Simpan harus diisi">
		...
		?>
                    <div class="form-group">
                        ...
                        <input type="text" onkeypress="return isNumberKey(event);"
                            value="<?php echo $nama['besar_simpanan'];?>" name="besar_simpanan" class="form-control"
                            id="besar_simpanan" size="54" />
                    </div>
                    <?php } 
        else { ?>
                    <div class="form-group">
                        ...
                        <input type="text" onkeypress="return isNumberKey(event);"
                            value="<?php echo $nama['besar_simpanan'];?>" name="besar_simpanan" class="form-control"
                            id="besar_simpanan" size="54" readonly />
                    </div>
                    <?php } ?>
                    <div class="form-group">
                        <label>User Entri</label>
                        <input type="text" name="user_entri" class="form-control" size="54"
                            value="<?php session_start(); echo $_SESSION['kopname'];?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Entri</label>
                        <input type="text" name="tgl_entri" class="form-control" size="54"
        ...
        <div class="col-lg-12">
            <div class="form-panel" style="width:50%;">
                ...
                <form action="transaksi/proses_pinjam.php" method="GET" id="form" name="frmAdd">
                    <div class="form-group">
                        <label>Kode Anggota</label>
                        <input type="text" class="form-control" name="kode_anggota" size="34"
                            title="Kode Anggota harus diisi" readonly="" value="<?php echo $data2['kode_anggota'];?>">
                    </div>
                    <div class="form-group">
                        <label>Nama Anggota</label>
                        <input type="text" class="form-control" name="nama_anggota" size="54" readonly
                            value="<?php echo $data2['nama_anggota'];?>" />
                    </div>
                    <div class="form-group">
                        <label>Pekerjaan</label>
                        <input type="text" class="form-control" name="pekerjaan" size="54" readonly
                            value="<?php echo $data2['pekerjaan'];?>" />
                    </div>
                    <div class="form-group">
                        <label>Jenis Pinjaman</label>
                        <select name="kode_jenis_pinjam" class="form-control" id="kode_jenis_pinjam"
                            onChange="show3(this.value)" class="required" title="Jenis Pinjaman harus diisi">
                            <?php
                $q=mysql_query("SELECT * FROM t_jenis_pinjam");
                while($a=mysql_fetch_array($q)){
                ?>
                            <option value="<?php echo $a['kode_jenis_pinjam'];?>"><?php echo $a['nama_pinjaman'];?>
                            </option>
                            <?php
                }
                ?>
                    ...
                    <div class="form-group">
                        ...
                        <input id="lama_angsuran" class="form-control" placeholder="Bulan" type="text"
                            name="lama_angsuran" style="width:100px;" readonly />
                    </div>
                    <div class="form-group">
                        <label>Maks Pinjaman</label>
                        <input id="maks_pinjam" class="form-control" type="text" name="maks_pinjam" size="54"
                            readonly />
                    </div>
                    <div class="form-group">
                        <label>Bunga (%)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onkeypress="return isNumberKey(event);" class="form-control"
                            name="besar_pinjaman" id="besar_pinjam" size="54" class="required"
                            title="Besar Pinjaman harus diisi" />
                    </div>
                    <div class="form-group">
                        <label>Angsuran</label>
                        <input type="text" class="form-control" name="besar_angsuran" id="besar_angsuran" size="54"
                            class="required" onFocus="startCalc();" onBlur="stopCalc();" readonly />
                    </div>
                    <div class="form-group">
                        <label>User Entri</label>
                        <input type="text" class="form-control" name="u_entry" size="54"
                            value="<?php session_start(); echo $_SESSION['kopname'];?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Entri</label>
                        <input type="text" class="form-control" name="tgl_entri" size="54"
                            value="<?php echo date("Y-m-d");?>" readonly />
                    </div>
            ...
            <div class="form-panel" style="width:50%;">
                ...
                <form action="transaksi/proses_transaksi.php?pros=angsur" method="post" id="form" name="frmAdd">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_anggota" size="54" readonly
                            value="<?php echo $data2['kode_anggota'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kode_pinjam" class="form-control" id="kode_pinjam" onChange="show2(this.value)"
                            class="required" title="Jenis Simpan harus diisi">
                            <option value="<?php echo $_GET['kode_pinjam']; ?>"><?php echo $_GET['kode_pinjam']; ?>
                            </option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="tgl_pinjam">Tanggal Pinjam</label>
                        <input id="tgl_pinjam" class="form-control" value="<?php echo $jio['tgl_entri'];?>" type="text"
                            name="tgl_pinjam" size="54" readonly />
                    </div>
                    <div class="form-group">
                        <label for="besar_pinjaman">Besar Pinjam</label>
                        <input type="text" class="form-control" name="besar_pinjam"
                            value="<?php echo $jio['besar_pinjam'];?>" id="besar_pinjam" value="" size="54" readonly
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="lama_angsuran"
                            value="<?php echo $jio['lama_angsuran'];?>" id="lama_angsuran" size="54" readonly
                            onFocus="startCalc();" onBlur="stopCalc();" />
                    </div>
                    <div class="form-group">
                        <label for="besar_angsur">Angsuran</label>
                        <input type="text" class="form-control" name="besar_angsur"
                            value="<?php echo $jio['besar_angsuran'];?>" id="besar_angsuran" size="54" readonly />
                    </div>
                    <div class="form-group">
                        <label for="sisa_pinjam">Angsuran Ke</label>
                        <input type="text" class="form-control" name="angsuran_ke"
                            value="<?php echo $jio['sisa_angsuran']+1;?>" id="angsuran_ke" size="54" />
                    </div>
                    <?php 	
...
{ $kode=$_GET['kode_anggota']; $anggota=mysql_fetch_array(mysql_query("SELECT nama_anggota from t_anggota where kode_anggota='$kode'")); ?>
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Transaksi
...
?>
    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                <h4 class="mb"><span class='glyphicon glyphicon-briefcase'></span> Laporan Simpanan Anggota
                    "<?php echo $ang['nama_anggota'];?>"
                    <?php
...
?>
                        <a href="laporan/print_show_simpanan.php?kode=<?php echo $ang['kode_anggota'];?>"
                            target="_blank" class="btn btn-primary"><span class='glyphicon glyphicon-print'></span>
                            Print</a>
                    </span></h4>
                <form class="form-inline" role="form">
                    <table class="table table-bordered table-striped table-condensed">
